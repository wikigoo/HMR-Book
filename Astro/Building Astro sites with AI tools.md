...
- [Streamable HTTP](#tab-panel-135)
- [Local Proxy](#tab-panel-136)
...
See the [CLI reference](https://docs.astro.build/en/reference/cli-reference/#astro-dev) for the full list of `astro dev` flags and subcommands.
