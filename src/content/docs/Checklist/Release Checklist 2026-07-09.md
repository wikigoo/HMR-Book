...
> ⚠️ **بلاکر شناخته‌شده:** OAuth client وب برای Google Sign-In هنوز ساخته نشده. چون login اجباری نیست و چت بدون ورود کار می‌کند، بلاکرِ انتشار نیست ولی قبل از فعال‌کردن دکمهٔ ورود باید حل شود.
